...
def gen_signal(main_dir, setup_file, do_pythia, pythia_card, generate_BSM, mg_dir, cards_folder_name,prepare_scripts, launch_SLURM_jobs):
    ...
    miner.run(
        mg_directory=mg_dir,
        log_directory=f'{main_dir}/logs/VBF_smeftsim_SM',
        mg_process_directory=f'{main_dir}/signal_samples/VBF_smeftsim_SM',
    ...
    if generate_BSM:
        ...
        miner.run(
            mg_directory=mg_dir,
            log_directory=f'{main_dir}/logs/VBF_smeftsim_pos_chwtil',
            mg_process_directory=f'{main_dir}/signal_samples/VBF_smeftsim_pos_chwtil',
            proc_card_file=f'{cards_folder_name}/proc_card_signal.dat',
            param_card_template_file=param_card_template_file,
            pythia8_card_file=pythia_card if do_pythia else None,
        ...
        miner.run(
            mg_directory=mg_dir,
            log_directory=f'{main_dir}/logs/VBF_smeftsim_neg_chwtil',
            mg_process_directory=f'{main_dir}/signal_samples/VBF_smeftsim_neg_chwtil',
            proc_card_file=f'{cards_folder_name}/proc_card_signal.dat',
            param_card_template_file=param_card_template_file,
            pythia8_card_file=pythia_card if do_pythia else None,
